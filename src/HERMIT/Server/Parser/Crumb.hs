...
instance External Crumb where
  parseExternals =
    ...
    , external "disjLhs" Disj_Lhs
        [ "Descend into left-hand side of a disjunction." ]
    , external "disjRhs" Disj_Rhs
